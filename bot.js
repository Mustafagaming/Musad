...
setInterval(() => {
  http.get(`https://github.com/Mustafagaming/Musad`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '459295654725025794'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '474687872818216962'; // تعديل مهم ايدي الروم الصوتي
...
const youtube = new YouTube(""); //تعديل مهم عدل الاي بي اي بواحد جديد او خليه زي ماهو
...
client.login(NDEzNzI5MzA0ODYyNzg1NTM2.G7kick.mWFeJc2M3qxBvuBtz8dzK6f4QZmksX9jJeDQzU);
